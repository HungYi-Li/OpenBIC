...
#define name_gpioF                                                                                 \
	gpio_name_to_num(Reserve_GPIOF0) gpio_name_to_num(IRQ_SMB_ALERT_N)                         \
		gpio_name_to_num(FM_P3V3_E1S_EN) gpio_name_to_num(FM_P12V_EDGE_EN)                 \
			gpio_name_to_num(Reserve_GPIOF4) gpio_name_to_num(IRQ_P3V3_EDGE_FLT_N)     \
...
#define name_gpioL                                                                                 \
	gpio_name_to_num(Reserve_GPIOL0) gpio_name_to_num(Reserve_GPIOL1)                          \
		gpio_name_to_num(FM_BOARD_REV_ID2) gpio_name_to_num(FM_BOARD_REV_ID1)              \
			gpio_name_to_num(FM_BOARD_REV_ID0) gpio_name_to_num(HSC_SEL_ID2)           \
				gpio_name_to_num(HSC_SEL_ID1) gpio_name_to_num(HSC_SEL_ID0)
// GPIOM6, M7 hardware not define
#define name_gpioM                                                                                 \
	gpio_name_to_num(Reserve_GPIOM0) gpio_name_to_num(Reserve_GPIOM1)                          \
		gpio_name_to_num(Reserve_GPIOM2) gpio_name_to_num(Reserve_GPIOM3)                  \
