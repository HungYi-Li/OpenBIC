...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_T_MB_OUTLET_TEMP_T, sensor_dev_tmp75, I2C_BUS2, TMP75_ADDR, TMP75_TEMP_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	...
	{ SENSOR_NUM_ADC_12V_VOL_M2A, sensor_dev_ast_adc, ADC_PORT8, NONE, NONE, is_m2_sen_readable,
	  704, 100, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[1] },
	...
	{ SENSOR_NUM_ADC_12V_VOL_M2C, sensor_dev_ast_adc, ADC_PORT10, NONE, NONE,
	  is_m2_sen_readable, 704, 100, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS, NULL, NULL,
	...
	{ SENSOR_NUM_ADC_3V3_VOL_M2A, sensor_dev_ast_adc, ADC_PORT6, NONE, NONE, is_m2_sen_readable,
	  487, 200, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	...
	{ SENSOR_NUM_INA231_PWR_M2A, sensor_dev_ina230, I2C_BUS_M2A, I2C_ADDR_M2_INA231,
	  INA231_POWER_REG, is_m2_sen_readable, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS,
	...
	{ SENSOR_NUM_INA231_VOL_M2A, sensor_dev_ina230, I2C_BUS_M2A, I2C_ADDR_M2_INA231,
	  INA231_BUS_VOLTAGE_REG, is_m2_sen_readable, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0,
	...
	{ SENSOR_NUM_NVME_TEMP_M2A, sensor_dev_nvme, I2C_BUS_M2A, NVME_ADDR, NVME_TEMP_REG,
	  is_m2_sen_readable, 0, 0, SAMPLE_COUNT_DEFAULT, POLL_TIME_DEFAULT,  0, SENSOR_INIT_STATUS, NULL, NULL, NULL,
	  NULL, NULL },
