...
sensor_cfg plat_sensor_config[] = {
	...
	// Voltage
	{ SENSOR_NUM_V_12_AUX, sensor_dev_ast_adc, ADC_PORT1, NONE, NONE, stby_access, 100, 704,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_V_12_EDGE, sensor_dev_ast_adc, ADC_PORT2, NONE, NONE, stby_access, 100, 704,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_V_3_3_AUX, sensor_dev_ast_adc, ADC_PORT7, NONE, NONE, stby_access, 200, 487,
	  SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
	{ SENSOR_NUM_ADC_12V_VOL_M2A, sensor_dev_ast_adc, ADC_PORT11, NONE, NONE,
	  is_m2_sen_readable, 100, 704, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL,
	...
	{ SENSOR_NUM_ADC_12V_VOL_M2C, sensor_dev_ast_adc, ADC_PORT9, NONE, NONE, is_m2_sen_readable,
	  100, 704, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[1] },
	...
	{ SENSOR_NUM_ADC_3V3_VOL_M2A, sensor_dev_ast_adc, ADC_PORT3, NONE, NONE, is_m2_sen_readable,
	  200, 487, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  &adc_asd_init_args[0] },
